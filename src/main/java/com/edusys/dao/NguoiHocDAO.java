...
public class NguoiHocDAO extends EduSysDAO<NguoiHoc, String> {
	...
	public void insert(NguoiHoc model) {
		...
		XJdbc.update(sql, model.getMaNH(), model.getHoTen(), model.getNgaySinh(), model.getGioiTinh(),
				model.getDienThoai(), model.getEmail(), model.getGhiChu(), model.getMaNV());
	}
	...
	public void update(NguoiHoc model) {
		...
		XJdbc.update(sql, model.getHoTen(), model.getNgaySinh(), model.getGioiTinh(), model.getDienThoai(),
				model.getEmail(), model.getGhiChu(), model.getMaNV(), model.getMaNH());
	}
