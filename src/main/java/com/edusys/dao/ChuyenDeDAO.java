...
public class ChuyenDeDAO extends EduSysDAO<ChuyenDe, String> {
	...
	public void insert(ChuyenDe model) {
		...
		XJdbc.update(sql, model.getMaCD(), model.getTenCD(), model.getHocPhi(), model.getThoiLuong(), model.getHinh(),
				model.getMoTa());
	}

	public void update(ChuyenDe model) {
		String sql = "UPDATE ChuyenDe SET TenCD=?, HocPhi=?, ThoiLuong=?, Hinh=?, MoTa=? WHERE MaCD=?";
		XJdbc.update(sql, model.getTenCD(), model.getHocPhi(), model.getThoiLuong(), model.getHinh(), model.getMoTa(),
				model.getMaCD());
	}
